...
import { coursesData } from '@/app/(main)/courses/page';
...
`;
  ...
  // Filter courses based on category query and search query
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 pb-12">
          ...
          <div className="flex items-center gap-2 text-sm font-medium mb-2">
            ...
            <span className="text-gray-500">
              {categoryFilter === 'popular'
                ? 'Popular'
                : categoryFilter === 'pro-specialist'
                  ? 'Pro & Specialist'
                  : categoryFilter === 'short'
                    ? 'Short Courses'
      ...
      {/* Info banner for search or category filters */}
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between bg-[#f0fcf9] border border-[#a2dcd1] rounded-xl px-4 py-3 text-sm text-gray-800 gap-2">
          <div className="flex items-center gap-2">
            <span>
              ...
              {searchQuery && categoryFilter && ' and '}
              {categoryFilter && (
                <span>
                  category <strong className="text-gray-900">
                    {categoryFilter === 'popular'
                      ? 'Popular'
                      : categoryFilter === 'pro-specialist'
                        ? 'Pro & Specialist'
      ...
      {filteredCourses.length > 0 ? (
        ...
        <div className="bg-white border border-gray-100 rounded-2xl p-12 text-center max-w-xl mx-auto space-y-4">
          ...
          <p className="text-sm text-gray-500">
            We couldn&apos;t find any courses matching your search. Try adjusting filters or search query.
          </p>
          <button
            onClick={() => {
