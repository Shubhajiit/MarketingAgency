      ...
      <div className="flex items-center justify-center p-8 bg-white text-slate-900">
        <div className="w-full max-w-[420px] overflow-hidden">
          ...
          <div className="mt-4">
            <Button
              variant="outline"
              className="w-full h-12 bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 rounded-full px-4 text-xs md:text-sm font-medium flex items-center justify-center gap-2 shadow-none transition-colors"
              type="button"
