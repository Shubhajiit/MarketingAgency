    ...
    <div className="flex-1 flex flex-col bg-white text-gray-900 relative">
      ...
      <div className="max-w-7xl w-full mx-auto px-4 pt-2 flex items-center gap-2 text-[13px] text-slate-500 font-medium select-none">
        <Link href="/" className="hover:text-[#0056d2] transition-colors">
          <svg className="w-4 h-4 shrink-0 text-slate-500 hover:text-[#0056d2]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
          </svg>
        </Link>
        <span className="text-slate-350 text-[11px] font-bold">&gt;</span>
        <Link href="/courses" className="hover:text-[#0056d2] transition-colors">Browse</Link>
        <span className="text-slate-350 text-[11px] font-bold">&gt;</span>
        <span className="hover:text-[#0056d2] transition-colors capitalize cursor-pointer">{course.category.replace("-", " & ")}</span>
        <span className="text-slate-350 text-[11px] font-bold">&gt;</span>
        <span className="text-slate-400 font-semibold">{course.tag}</span>
      </div>

      {/* 1. Header Section */}
      <header className="relative w-full mt-2 bg-[#f8fafd] border-y border-slate-100 overflow-hidden pt-8 pb-24 md:pt-10 md:pb-28">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1.5 text-[13px] text-slate-500 font-medium">
              ...
              <span className="flex items-center gap-1 whitespace-nowrap">
                Included with <span className="bg-[#0056d2] text-white text-[9px] font-black px-1 py-0.5 rounded leading-none">coursera</span> <span className="text-[#0056d2] font-black tracking-tight ml-0.5">PLUS</span> <span className="mx-1.5 text-slate-300">•</span> <span className="text-[#0056d2] underline hover:text-[#00419e] cursor-pointer">Learn more</span>
              </span>
            </div>
          </div>
      ...
      <section className="relative z-20 max-w-7xl w-full mx-auto px-4">
        <div className="bg-white rounded-xl border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.03)] -mt-10 md:-mt-12 p-6 md:p-7">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-6 md:gap-4 divide-y sm:divide-y-0 md:divide-x divide-slate-100 text-left">
            
            {/* 1. Guided Project Type */}
            <div className="flex flex-col pr-2">
              <span className="font-bold text-slate-800 text-[18px] hover:underline cursor-pointer">
                {detailMeta.type}
              </span>
            ...
            {/* 2. Rating */}
            <div className="flex flex-col pt-4 sm:pt-0 md:pl-5">
              <span className="font-bold text-slate-800 text-[18px] flex items-center gap-1.5">
      ...
      <main className="max-w-7xl w-full mx-auto px-4 py-12 md:py-16 grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12">
        
        {/* Left Column: Syllabus & About */}
        <div className="lg:col-span-7 flex flex-col gap-8">
          
          {/* Horizontal Navigation Tabs */}
          <div className="border-b border-slate-200 flex gap-6 pb-2 mb-2 overflow-x-auto whitespace-nowrap scrollbar-none select-none">
            {[
              ...
              <button
                ...
                className={`px-3.5 py-2 text-[14.5px] font-semibold transition-all cursor-pointer rounded-md ${
                  activeSubTab === tab.id
          ...
          {activeSubTab === "about" && (
            <div className="flex flex-col gap-10 animate-in fade-in duration-200">
              ...
              <section className="flex flex-col gap-5 border-t border-slate-100 pt-8">
                <h3 className="text-[19px] font-bold text-slate-900 tracking-tight">
                  Details to know
                </h3>
          ...
          {activeSubTab === "reviews" && (
            <div className="flex flex-col gap-8 animate-in fade-in duration-200">
              <section className="flex flex-col gap-4">
                <h3 className="text-[19px] font-bold text-slate-900 tracking-tight">Student Reviews</h3>
                
                {/* Score panel */}
                <div className="flex flex-col sm:flex-row items-center gap-6 p-6 border border-slate-100 rounded-lg bg-slate-50/50 shadow-xs">
                  <div className="flex flex-col items-center justify-center">
                    <span className="text-5xl font-black text-[#0056d2]">{detailMeta.rating}</span>
                    <div className="flex text-[#fca130] text-base mt-2">★★★★★</div>
                    <span className="text-xs text-slate-400 font-semibold mt-1">Course Score</span>
                  </div>
                  ...
                  <div className="flex-1 flex flex-col gap-2 w-full">
                    {[
                      ...
                      <div key={row.stars} className="flex items-center gap-3 w-full text-xs font-semibold text-slate-600">
                        <span className="w-10">{row.stars} stars</span>
                        <div className="flex-1 bg-slate-200 h-2 rounded-full overflow-hidden">
                          <div className="bg-[#0056d2] h-full" style={{ width: `${row.pct}%` }}></div>
                        </div>
              ...
              <section className="flex flex-col gap-4 border-t border-slate-100 pt-6">
                {[
                  { name: "Divya S.", date: "May 2026", text: "Absolutely loved the content! The labs are extremely comprehensive and the concepts are laid out very logically. Easy to follow." },
                  { name: "Mark A.", date: "April 2026", text: "Hands-on projects were the best part. I was able to build a automation system for my own work immediately." }
                ].map((r, idx) => (
                  <div key={idx} className="border-b border-slate-100 pb-4 last:border-0 flex flex-col gap-1 text-left">
                    ...
                    <div className="flex text-[#fca130] text-[10px] mt-0.5">★★★★★</div>
      ...
      {activeSubTab === "about" && (
        <section className="w-full bg-[#f8fafd] border-y border-slate-100 py-12 md:py-16 mt-8">
          <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden">
            ...
            <div className="w-full md:w-[35%] flex items-center justify-center z-10 shrink-0">
      ...
      {/* Why people choose AIScale for their career (Full Width) */}
      {activeSubTab === "about" && (
        <section className="w-full bg-white py-12 md:py-16 mt-2 border-b border-slate-100">
          <div className="max-w-7xl mx-auto px-4 text-left">
            <h3 className="text-2xl md:text-3.5xl font-extrabold text-slate-900 tracking-tight mb-8">
              Why people choose AIScale for their career
            </h3>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {/* Card 1 */}
              <div className="border border-slate-150 rounded-xl p-6 bg-white shadow-[0_4px_15px_rgba(0,0,0,0.01)] hover:shadow-md transition-all flex flex-col gap-4">
                ...
                <p className="text-[13px] text-slate-650 leading-relaxed font-medium italic">
