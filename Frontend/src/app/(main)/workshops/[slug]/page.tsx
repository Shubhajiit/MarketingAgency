...
function WorkshopSkeleton() {
  return (
    <div className="flex-1 flex flex-col bg-white">
      <div>
        <div className="bg-zinc-950 h-[400px]" />
        <div className="max-w-7xl mx-auto px-4 md:px-16 py-12 space-y-6 animate-pulse">
...
export default function DynamicWorkshopPage() {
  ...
  const handleScrollToBook = () => {
    const el = document.getElementById('brochure-firstName-input');
    if (el) {
...
=========================================
  ...
  if (notFound || !workshop) return <WorkshopNotFound />;
      ...
      <main className="flex-1 flex flex-col">
        ...
        >
          <div className="absolute inset-0 z-0 w-full h-full">
            <img
              src={workshop.heroImage || "https://images.unsplash.com/photo-1524178232363-1fb2b075b655?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80"}
              alt={workshop.title}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <div className="flex flex-col relative">
                      <select name="workExperience" value={formData.workExperience} onChange={handleInputChange} id="brochure-workExperience-select"
                        className={`w-full text-sm px-3 py-2 border rounded focus:outline-none transition-colors appearance-none bg-white pr-8 ${errors.workExperience ? 'border-red-500 focus:border-red-500 focus:ring-1 focus:ring-red-500' : 'border-gray-300 focus:border-gray-900'}`}>
