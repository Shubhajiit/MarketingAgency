...
export default function Footer() {
    ...
    return (
        <footer className="w-full bg-white border-t border-slate-200 text-slate-900 pt-16 pb-8 px-4 md:px-36 font-sans">
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 pb-16">
                    {/* Left Column: Brand & Subscription */}
                    <div className="col-span-12 lg:col-span-5 flex flex-col gap-6 lg:pr-12 lg:border-r border-slate-200">
                        {/* Logo */}
                        ...
                        {/* Tagline */}
                        <h2 className="text-3xl md:text-4xl font-serif font-medium text-slate-800 leading-tight tracking-wide">
                            Helping minds grow through adaptive AI learning
                        </h2>

                        {/* Subscription Form */}
                        <form onSubmit={handleSubscribe} className="flex items-center gap-2.5 mt-2 max-w-md w-full relative">
                            <input
                                type="email"
                                required
                                ...
                                className="flex-1 bg-white text-slate-900 border border-slate-300 rounded-md px-4 py-2.5 text-sm focus:outline-none focus:border-red-500 focus:ring-1 focus:ring-red-500 transition-all placeholder:text-slate-400"
                            />
                            <button
                                type="submit"
                                className="bg-[#FF2E00] hover:bg-[#D62400] active:bg-[#B31E00] text-white text-sm font-semibold px-6 py-2.5 rounded-md transition-all duration-200 shadow-sm whitespace-nowrap"
                            >
                                Subscribe
                            </button>
                            {subscribed && (
                                <span className="absolute left-0 -bottom-6 text-xs text-green-600 font-medium">
                    ...
                    <div className="col-span-12 lg:col-span-7 grid grid-cols-2 md:grid-cols-4 gap-8 lg:pl-12">
                ...
                <div className="border-t border-slate-200 pt-8 flex flex-col md:flex-row items-center justify-between gap-6">
                    ...
                    <div className="flex items-center gap-2">
                        <a
                            href="#"
                            aria-label="Facebook"
                            className="w-9 h-9 rounded border border-slate-200 flex items-center justify-center text-slate-400 hover:text-slate-900 hover:border-slate-400 transition-all"
                        >
